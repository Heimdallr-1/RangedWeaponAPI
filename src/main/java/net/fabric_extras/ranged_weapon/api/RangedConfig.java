...
public record RangedConfig(int pull_time, float damage, float velocity) {
    ...
    public static final RangedConfig BOW = new RangedConfig(20, (float) ScalingUtil.BOW_BASELINE.damage(), ScalingUtil.STANDARD_BOW_VELOCITY);
    public static final RangedConfig CROSSBOW = new RangedConfig(25, (float) ScalingUtil.CROSSBOW_BASELINE.damage(), ScalingUtil.STANDARD_CROSSBOW_VELOCITY);
}
